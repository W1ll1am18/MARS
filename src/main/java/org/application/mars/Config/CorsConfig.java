...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000","http://localhost:4173", "http://localhost:4200", "http://localhost:5173", "https://mars-frontend-one.vercel.app"));
